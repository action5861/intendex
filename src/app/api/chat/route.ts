...
[중요] 신규 카테고리 의도 감지 규칙:
- **AI서비스**: "ChatGPT", "Claude", "Gemini", "AI 챗봇", "AI 에이전트", "미드저니", "Midjourney", "이미지 생성", "AI 그림", "자동화", "Dify", "Character.AI" 등 → category: "AI서비스", pointValue: 900~1000
- **숏폼스트리밍**: "틱톡", "TikTok", "릴스", "Reels", "쇼츠", "Shorts", "트위치", "Twitch", "치지직", "CHZZK", "아프리카TV", "스트리밍", "라이브 방송" 등 → category: "숏폼스트리밍", pointValue: 700~800
- **디지털웰니스**: "명상", "마음챙김", "멘탈헬스", "심리상담", "스트레스", "불안", "Headspace", "Calm", "디지털 치료" 등 → category: "디지털웰니스", pointValue: 600~700
- **친환경**: "제로웨이스트", "친환경", "탄소중립", "지속가능", "비건", "리사이클", "업사이클", "그린" 등 → category: "친환경", pointValue: 500~600
- **크리에이터**: "유튜버", "크리에이터", "팬플랫폼", "구독", "Patreon", "브런치", "멤버십", "후원하기", "콘텐츠 제작" 등 → category: "크리에이터", pointValue: 700~800
- **딥테크**: "스타트업", "투자", "VC", "시리즈A", "IR", "창업", "딥테크", "기술창업", "더브이씨" 등 → category: "딥테크", pointValue: 800~900
- **디지털자산**: "NFT", "암호화폐", "비트코인", "이더리움", "코인", "업비트", "빗썸", "Web3", "블록체인", "토큰" 등 → category: "디지털자산", pointValue: 700~800
...
[중요] 상업적 의도 포인트 가치 판단 기준 (추천 사이트 20초 이상 체류 시 비례 지급):
- **최고가치 (900~1000P)**: 보험, 대출, 부동산, 자동차, AI 에이전트/서비스, 딥테크, 스타트업 투자, B2B SaaS, 법률 서비스
- **고가치 (700~800P)**: 여행 패키지, 가전제품, 명품, 의료/성형, 크리에이터 플랫폼, 숏폼 콘텐츠, 디지털 자산/NFT/암호화폐, 디지털 웰니스/멘탈헬스
- **중간 가치 (400~600P)**: 교육/학원, 인테리어, 건강보조식품, 구독 서비스, 친환경/제로웨이스트
...
\`\`\`intents
{
  "intents": [
    {
      "category": "카테고리 (여행/쇼핑/건강/교육/금융/음식/패션/테크/부동산/자동차/취미/지역정보/비영리/AI서비스/숏폼스트리밍/디지털웰니스/친환경/크리에이터/딥테크/디지털자산/기타 중 하나)",
...
포인트는 추천 사이트에 20초 이상 체류 시 비례 지급, 60초 완료 시 전액 지급됩니다.
