...
const campaigns = [
  ...
  },
  {
    ...
    category: "테크",
    keywords: ["가전", "냉장고", "에어컨", "세탁기", "건조기", "청소기", "다이슨", "가전제품"],
    budget: 1800000,
    costPerMatch: 700,
  ...
  {
    title: "삼성전자 냉장고·세탁기 특가",
    description: "삼성 비스포크 냉장고·세탁기·에어컨 최신 모델 공식몰 특가 구매",
    category: "테크",
    keywords: ["냉장고", "세탁기", "건조기", "에어컨", "삼성 가전", "비스포크", "TV", "삼성전자", "가전제품", "삼성 냉장고", "삼성 세탁기", "텔레비전"],
    budget: 2000000,
    costPerMatch: 700,
  ...
  {
    title: "LG전자 가전 할인 프로모션",
    description: "LG 휘센 에어컨·트롬 세탁기·디오스 냉장고 신제품 직구매 혜택",
    category: "테크",
    keywords: ["냉장고", "세탁기", "에어컨", "LG 가전", "휘센", "트롬", "디오스", "LG전자", "가전제품", "LG 냉장고", "LG 세탁기", "공기청정기", "식기세척기"],
    budget: 2000000,
    costPerMatch: 700,
  ...
  {
    title: "삼성생명 보험 상담",
    description: "삼성생명 종신보험·연금보험·건강보험·암보험 무료 상담",
    category: "금융",
    keywords: ["삼성생명", "생명보험", "종신보험", "연금보험", "보험", "보험상담", "보험추천", "암보험", "건강보험", "실손보험", "CI보험", "간병보험"],
    budget: 1000000,
    costPerMatch: 1000,
  ...
  {
    title: "한화생명 저축보험 이벤트",
    description: "한화생명 저축보험·변액보험 가입 상담",
    category: "금융",
    keywords: ["한화생명", "저축보험", "변액보험", "보험", "생명보험", "연금", "암보험", "건강보험", "실손보험", "CI보험"],
    budget: 800000,
    costPerMatch: 900,
  ...
  {
    title: "교보생명 건강보험 상담",
    description: "교보생명 건강보험·암보험·실손보험 무료 설계",
    category: "금융",
    keywords: ["교보생명", "건강보험", "암보험", "실손보험", "보험설계", "보험비교"],
    budget: 800000,
    costPerMatch: 900,
  ...
  {
    title: "현대해상 다이렉트 자동차보험",
    description: "현대해상 자동차보험 다이렉트 가입 시 최대 할인",
    category: "금융",
    keywords: ["현대해상", "자동차보험", "다이렉트보험", "보험료", "차보험", "운전자보험"],
    budget: 1000000,
    costPerMatch: 1000,
  ...
  {
    title: "DB손해보험 실손보험 가입",
    description: "DB손해보험 실손의료보험·운전자보험 상담",
    category: "금융",
    keywords: ["DB손해보험", "실손보험", "의료보험", "손해보험", "운전자보험", "여행자보험", "암보험", "건강보험"],
    budget: 800000,
    costPerMatch: 900,
  ...
  {
    title: "KB손해보험 보험비교",
    description: "KB손해보험 자동차·건강·여행자보험 비교견적",
    category: "금융",
    keywords: ["KB손해보험", "보험비교", "건강보험", "여행자보험", "KB보험", "암보험", "실손보험", "운전자보험"],
    budget: 700000,
    costPerMatch: 800,
  ...
  {
    title: "메리츠화재 보험 상담",
    description: "메리츠화재 암보험·치아보험·펫보험 무료 상담",
    category: "금융",
    keywords: ["메리츠화재", "메리츠보험", "암보험", "치아보험", "펫보험", "화재보험"],
    budget: 700000,
    costPerMatch: 800,
  ...
  {
    title: "국민은행 예적금 상품",
    description: "KB국민은행 고금리 예적금·적금 상품 안내",
    category: "금융",
    keywords: ["국민은행", "KB", "예금", "적금", "예적금", "금리", "저축", "은행", "대출", "전세대출", "전세자금", "주택담보대출", "신용대출", "주담대"],
    budget: 1000000,
    costPerMatch: 800,
  ...
  {
    title: "신한은행 SOL 뱅킹",
    description: "신한은행 모바일뱅킹 SOL 가입 이벤트",
    category: "금융",
    keywords: ["신한은행", "신한", "SOL", "모바일뱅킹", "예금", "적금", "은행", "대출", "전세대출", "전세자금", "주택담보대출", "신용대출"],
    budget: 1000000,
    costPerMatch: 800,
  ...
  {
    title: "하나은행 하나원큐 이벤트",
    description: "하나은행 하나원큐 신규가입 혜택",
    category: "금융",
    keywords: ["하나은행", "하나원큐", "예금", "적금", "외환", "환전", "은행", "대출", "전세대출", "전세자금", "주택담보대출", "신용대출"],
    budget: 800000,
    costPerMatch: 700,
  ...
  {
    title: "우리은행 WON뱅킹",
    description: "우리은행 WON뱅킹 가입 시 금리우대 이벤트",
    category: "금융",
    keywords: ["우리은행", "WON뱅킹", "예금", "적금", "은행", "금리우대", "대출", "전세대출", "전세자금", "주택담보대출", "신용대출"],
    budget: 800000,
    costPerMatch: 700,
  ...
  {
    title: "NH농협은행 올원뱅크",
    description: "NH농협은행 올원뱅크 예적금·대출 상품 안내",
    category: "금융",
    keywords: ["농협", "NH", "농협은행", "올원뱅크", "예금", "적금", "은행", "농축협", "대출", "전세대출", "농업자금대출", "신용대출"],
    budget: 700000,
    costPerMatch: 600,
  ...
  {
    title: "카카오뱅크 비상금대출",
    description: "카카오뱅크 비상금대출·26주적금 가입 안내",
    category: "금융",
    keywords: ["카카오뱅크", "비상금대출", "26주적금", "모바일은행", "인터넷은행", "신용대출", "전세대출", "주택담보대출"],
    budget: 1000000,
    costPerMatch: 800,
  ...
  {
    title: "토스뱅크 먼저이자받는적금",
    description: "토스뱅크 고금리 적금·통장 상품 안내",
    category: "금융",
    keywords: ["토스뱅크", "토스", "적금", "예금", "이자", "인터넷은행", "통장", "대출", "신용대출", "비상금대출"],
    budget: 1000000,
    costPerMatch: 800,
  ...
  {
    title: "IBK기업은행 대출·금융 상품",
    description: "IBK기업은행 전세자금대출·주택담보대출·신용대출·소상공인 대출 상담",
    category: "금융",
    keywords: ["기업은행", "IBK", "전세대출", "전세자금", "전세자금대출", "주택담보대출", "신용대출", "소상공인대출", "사업자대출", "대출", "중소기업대출"],
    budget: 1200000,
    costPerMatch: 900,
  ...
  // 생활편의 및 서비스
  {
    title: "숨고 생활 서비스 첫 이용 할인",
    description: "숨고·크몽 청소·수리·인테리어 생활 서비스 첫 이용 시 30% 할인",
    category: "기타",
    keywords: ["생활서비스", "청소", "수리", "인테리어", "세탁", "집청소", "에어컨청소"],
    budget: 500000,
    costPerMatch: 300,
  ...
  {
    title: "짐카 포장이사 견적 비교",
    description: "전국 이사업체 견적 한번에 비교, 포장이사·일반이사·보관이사 최저가 보장",
    category: "기타",
    keywords: ["이사", "포장이사", "이사업체", "이삿짐", "이사견적", "이사비용", "이사업체추천", "용달이사", "반포장이사"],
    budget: 800000,
    costPerMatch: 500,
    url: "https://www.zimcar.co.kr",
    siteName: "짐카",
    startDate: new Date("2026-01-01"),
    endDate: new Date("2026-12-31"),
  },
  ...
  {
    title: "SKT 번호이동 혜택",
    description: "SKT로 번호이동 시 최신 스마트폰 공시지원금 + 요금제 할인 혜택",
    category: "테크",
    keywords: ["번호이동", "통신사 변경", "SKT 번호이동", "SKT 변경", "SK텔레콤", "T월드", "5G 요금제", "통신사 추천"],
    budget: 1500000,
    costPerMatch: 800,
  ...
  {
    title: "KT 번호이동 혜택",
    description: "KT로 번호이동 시 스마트폰 지원금 + 첫 3개월 요금 할인",
    category: "테크",
    keywords: ["번호이동", "통신사 변경", "KT 번호이동", "KT 변경", "KT 5G", "올레 KT", "요금제 비교"],
    budget: 1500000,
    costPerMatch: 800,
  ...
  {
    title: "LG U+ 번호이동 혜택",
    description: "LG U+로 번호이동 시 공시지원금 최대 + 유튜브 프리미엄 무료",
    category: "테크",
    keywords: ["번호이동", "통신사 변경", "LGU+ 번호이동", "LG 번호이동", "유플러스 변경", "U+ 5G"],
    budget: 1500000,
    costPerMatch: 800,
  ...
  {
    title: "알뜰폰 번호이동 요금제 비교",
    description: "주요 알뜰폰 통신사 요금제 한눈에 비교, 번호이동 시 월 1만원대 이용",
    category: "테크",
    keywords: ["알뜰폰", "알뜰폰 번호이동", "MVNO", "저렴한 요금제", "알뜰폰 추천", "통신비 절약", "선불폰"],
    budget: 600000,
    costPerMatch: 400,
  ...
  // 통신·인터넷 가입
  {
    title: "KT 인터넷·IPTV 가입 혜택",
    description: "KT 기가인터넷 신규 가입 시 현금 캐시백 + 공유기 무료 제공",
    category: "테크",
    keywords: ["인터넷 가입", "인터넷 신청", "KT 인터넷", "기가인터넷", "인터넷 설치", "IPTV", "올레tv", "인터넷 속도"],
    budget: 1200000,
    costPerMatch: 700,
    url: "https://www.kt.com",
    siteName: "KT",
  ...
  {
    title: "SK브로드밴드 인터넷 가입 이벤트",
    description: "SK브로드밴드 인터넷 신규 가입 고객 최대 30만원 캐시백",
    category: "테크",
    keywords: ["인터넷 가입", "SK 인터넷", "SK브로드밴드", "인터넷 신청", "Btv", "인터넷 설치", "와이파이 가입"],
    budget: 1000000,
    costPerMatch: 700,
  ...
  {
    title: "LG U+ 인터넷 가입 프로모션",
    description: "LG U+ 인터넷 신규 가입 시 넷플릭스 3개월 무료 + 캐시백",
    category: "테크",
    keywords: ["인터넷 가입", "LG 인터넷", "LGU+", "유플러스", "인터넷 신청", "U+tv", "인터넷 설치", "통신사 인터넷"],
    budget: 1000000,
    costPerMatch: 700,
    url: "https://www.lguplus.com",
    siteName: "LG U+",
  ...
  // 비영리·기부·봉사
  {
    title: "굿네이버스 아동 후원 캠페인",
    description: "결식아동·학대피해아동 보호를 위한 정기후원 안내",
    category: "비영리",
    keywords: ["기부", "후원", "아동보호", "결식아동", "아동학대", "굿네이버스", "어린이", "아동후원", "정기후원"],
    budget: 300000,
    costPerMatch: 100,
  ...
  {
    title: "월드비전 해외아동 후원",
    description: "전 세계 빈곤 아동을 위한 1:1 결연 후원 프로그램",
    category: "비영리",
    keywords: ["월드비전", "해외후원", "아동후원", "기부", "결연", "빈곤", "난민", "구호", "국제구호"],
    budget: 300000,
    costPerMatch: 100,
    url: "https://www.worldvision.or.kr",
    siteName: "월드비전",
    startDate: new Date("2026-01-01"),
    endDate: new Date("2026-12-31"),
  },
  {
    title: "유니세프 긴급구호 후원",
    description: "전쟁·재난 피해 어린이를 위한 긴급구호 기부",
    category: "비영리",
    keywords: ["유니세프", "긴급구호", "난민", "전쟁", "재난", "기부", "어린이", "구호활동"],
    budget: 300000,
    costPerMatch: 100,
  ...
  {
    title: "환경보호 기부 캠페인",
    description: "기후위기 대응·해양보호·산림복원을 위한 환경 기부",
    category: "비영리",
    keywords: ["환경", "기후변화", "탄소중립", "해양보호", "산림", "그린피스", "환경보호", "나무심기", "플로깅"],
    budget: 200000,
    costPerMatch: 100,
  ...
  {
    title: "유기동물 보호 기부",
    description: "유기·학대 동물 보호 및 입양 지원 캠페인",
    category: "비영리",
    keywords: ["유기동물", "동물보호", "입양", "동물학대", "유기견", "유기묘", "봉사", "동물복지"],
    budget: 200000,
    costPerMatch: 100,
  ...
  {
    title: "해피빈 기부·봉사 플랫폼",
    description: "다양한 사회공헌 프로젝트에 간편하게 기부하기",
    category: "비영리",
    keywords: ["해피빈", "기부", "봉사", "사회공헌", "나눔", "모금", "자원봉사", "봉사활동", "기부금"],
    budget: 200000,
    costPerMatch: 100,
    url: "https://happybean.naver.com",
    siteName: "해피빈",
    startDate: new Date("2026-01-01"),
    endDate: new Date("2026-12-31"),
  },
